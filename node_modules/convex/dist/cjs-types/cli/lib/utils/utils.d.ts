...
export declare function logNoDefaultRegionMessage(teamSlug: string): void;
...
export declare function selectRegion(ctx: Context, teamId: number, deploymentType: CloudDeploymentType): Promise<string>;
