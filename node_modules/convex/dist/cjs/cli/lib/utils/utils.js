...
function logNoDefaultRegionMessage(teamSlug) {
  const noDefaultRegionMessage = import_chalk.chalkStderr.gray(
    `Tip: you can configure a default region for your team at ${import_chalk.chalkStderr.underline(`https://dashboard.convex.dev/t/${teamSlug}/settings`)}`
  );
