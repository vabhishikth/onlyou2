...
| **Install `expo-dev-client` + first EAS iOS build**                                                                                                                                                                                                                                                                                             | Plan 2C (pre-task, before any UI work)                     | Decouples the founder's device-test loop from Apple's App Store update cycle. Founder has Apple Dev account; EAS cloud builds work on Windows. See `docs/decisions/2026-04-14-expo-sdk-and-dev-client.md`.   |
| **Bump Expo SDK 54 → latest stable**                                                                                                                                                                                                                                                                                                            | Plan 2C (after dev client is live)                         | Phase 2B walkthrough discovered App Store Expo Go lags new SDKs by weeks; downgraded 55 → 54 to unblock founder. Once dev client ships, the App Store cadence stops mattering and we resume "always latest". |
