...
_File generated: 2026-04-24. Regenerated from `packages/core/seeds/biomarker-ranges.json` — if you see a different row count, the source of truth has drifted; re-run `pnpm tsx scripts/export-ranges-for-review.ts`._
